...
public class Portfolio implements Parcelable {
    ...
    public Portfolio(String name, String position, Education education, Courses course, String githubUserName) {
        this.name = name;
    ...
    protected Portfolio(Parcel in) {
        ...
        this.course = in.readParcelable(Courses.class.getClassLoader());
